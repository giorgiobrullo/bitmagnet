...
function TorrentMetricsComponent_ng_container_0_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("value", ctx_r1.torrentMetricsController.params.source ?? "_all");
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(3);
    \u0275\u0275property("value", ctx_r1.torrentMetricsController.params.event ?? "_all");
    \u0275\u0275advance(3);
...
var TorrentsDashboardComponent = class _TorrentsDashboardComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TorrentsDashboardComponent, selectors: [["app-torrents"]], decls: 1, vars: 0, consts: [[4, "transloco"], [3, "parts"], [1, "dashboard-card"], ["svgIcon", "magnet"]], template: function TorrentsDashboardComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TorrentsDashboardComponent, [{
    type: Component,
    args: [{ selector: "app-torrents", standalone: true, imports: [AppModule, TorrentMetricsComponent, DocumentTitleComponent], template: `<ng-container *transloco="let t">
...
//# sourceMappingURL=chunk-4FKBEUV3.js.map
