...
// src/app/themes/theme-constants.ts
var themeBaseColors = [
  "primary",
  "secondary",
  "tertiary",
...
var themeColorHues = [20, 40, 50, 60, 80];
var themeColors = [
  "background",
  "foreground",
  ...themeBaseColors.flatMap((baseColor) => themeColorHues.map((n) => `${baseColor}-${n}`))
];
var emptyThemeInfo = {
  type: "light",
  colors: {}
...
// src/app/themes/theme-info.service.ts
var ThemeInfoService = class _ThemeInfoService {
  constructor() {
    this.infoSubject = new BehaviorSubject(emptyThemeInfo);
  ...
  static {
    this.\u0275fac = function ThemeInfoService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ThemeInfoService)();
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ThemeInfoService, factory: _ThemeInfoService.\u0275fac, providedIn: "root" });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ThemeInfoService, [{
    type: Injectable,
...
lodash-es/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UQ3IWFEE.js.map
