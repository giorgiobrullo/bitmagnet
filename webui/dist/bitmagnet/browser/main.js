...
var routes = [
  ...
  },
  {
    ...
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-ZYDC4KTG.js").then((c) => c.TorrentsSearchComponent)
      },
      {
        path: "permalink/:infoHash",
        loadComponent: () => import("./chunk-IYQDWLNA.js").then((c) => c.TorrentPermalinkComponent)
      }
    ]
  },
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-NPJ3WX2X.js").then((c) => c.DashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-DBNYCCRY.js").then((c) => c.DashboardHomeComponent)
      },
      {
        path: "dht",
        loadComponent: () => import("./chunk-SQC6UPU5.js").then((c) => c.DhtDashboardComponent)
      },
      {
        path: "queues",
        pathMatch: "full",
      ...
      {
        path: "queues",
        loadComponent: () => import("./chunk-ZBQHRBW7.js").then((c) => c.QueueDashboardComponent),
        children: [
          {
            path: "visualize",
            loadComponent: () => import("./chunk-YLMLOYCR.js").then((c) => c.QueueVisualizeComponent)
          },
          {
            path: "jobs",
            loadComponent: () => import("./chunk-D3UZNDYF.js").then((c) => c.QueueJobsComponent)
          },
          {
            path: "admin",
            loadComponent: () => import("./chunk-HPBP4HJJ.js").then((c) => c.QueueAdminComponent)
          }
        ]
      },
      {
        path: "torrents",
        loadComponent: () => import("./chunk-4FKBEUV3.js").then((c) => c.TorrentsDashboardComponent)
      }
    ]
  },
  {
    path: "**",
    loadComponent: () => import("./chunk-H3AMTACJ.js").then((c) => c.NotFoundComponent)
  }
];
