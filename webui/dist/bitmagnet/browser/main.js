...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
  ...
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-QYAJ5LKN.js").then((m) => m);
...
var en_default = {
  ...
  dates: {
    ...
    time_frame_placeholder: "e.g. 7d, today, last month",
    time_frame_tooltip: "Enter a time frame like '7d', 'today', or '2023-01-01 to 2023-01-31'",
    time_frame_error: "Invalid time frame",
    presets: "Presets",
    quick_presets: "Quick Presets",
    more_presets: "More Options",
    date_range: "Date Range",
    select_date_range: "Enter a date range",
    date_range_hint: "MM/DD/YYYY \u2013 MM/DD/YYYY",
    invalid_start_date: "Invalid start date",
    invalid_end_date: "Invalid end date",
    custom: "Custom",
    custom_time_hint: "Example: '7d', 'today', 'Jan 1, 2023 to Jan 31, 2023'",
    selected_range: "Selected Range",
    calendar: "Calendar",
    date_picker: "Select dates using calendar",
  ...
  dashboard: {
    dht: {
      nodes: "Nodes",
      nodes_ipv4: "IPv4 Nodes",
      nodes_ipv6: "IPv6 Nodes",
      hashes: "Hashes",
      hashes_ipv4: "IPv4 Hashes",
      hashes_ipv6: "IPv6 Hashes",
      ...
      nodes_over_time: "Nodes Over Time",
  ...
  health: {
    ...
    workers: {
      dht_crawler: "DHT crawler",
      dht_snapshots: "DHT snapshots",
      http_server: "HTTP server",
      queue_server: "Queue server",
      torrent_snapshots: "Torrent snapshots"
    }
  },
  languages: {
    af: "Afrikaans",
  ...
  torrents: {
    ...
    clear_size_filter: "Clear Size Filter",
    copy: "Copy",
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TranslocoImportLoader, [{
    type: Injectable,
...
var routes = [
  ...
  {
    path: "torrents",
    loadComponent: () => import("./chunk-5C7QN35I.js").then((c) => c.TorrentsComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-CZSFITDF.js").then((c) => c.TorrentsSearchComponent)
      },
      {
        path: "permalink/:infoHash",
        loadComponent: () => import("./chunk-FIWCGZNO.js").then((c) => c.TorrentPermalinkComponent)
      }
    ]
  },
  {
    path: "dashboard",
    loadComponent: () => import("./chunk-VKLWW4HI.js").then((c) => c.DashboardComponent),
    children: [
      {
        path: "",
        loadComponent: () => import("./chunk-KE6NKI4I.js").then((c) => c.DashboardHomeComponent)
      },
      {
        path: "dht",
        loadComponent: () => import("./chunk-E7VYGYHQ.js").then((c) => c.DhtDashboardComponent)
      },
      {
        path: "queues",
        pathMatch: "full",
      ...
      {
        path: "queues",
        loadComponent: () => import("./chunk-X32LZFXZ.js").then((c) => c.QueueDashboardComponent),
        children: [
          {
            path: "visualize",
            loadComponent: () => import("./chunk-H6L6TKQR.js").then((c) => c.QueueVisualizeComponent)
          },
          {
            path: "jobs",
            loadComponent: () => import("./chunk-BBHD7CJA.js").then((c) => c.QueueJobsComponent)
          },
          {
            path: "admin",
            loadComponent: () => import("./chunk-AJITSOVV.js").then((c) => c.QueueAdminComponent)
          }
        ]
      },
      {
        path: "torrents",
        loadComponent: () => import("./chunk-2OTUUZ2H.js").then((c) => c.TorrentsDashboardComponent)
      }
    ]
  },
  {
    path: "**",
    loadComponent: () => import("./chunk-B4ERIHQQ.js").then((c) => c.NotFoundComponent)
  }
];
...
var VersionComponent = class _VersionComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _VersionComponent, selectors: [["app-version"]], decls: 1, vars: 0, consts: [[4, "transloco"], [1, "version", 3, "matTooltip"]], template: function VersionComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(VersionComponent, [{
    type: Component,
    args: [{ selector: "app-version", standalone: true, imports: [AppModule, GraphQLModule], template: `<ng-container *transloco="let t">
  <span
    class="version"
    [matTooltip]="
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TranslateManager, [{
    type: Injectable,
    args: [{ providedIn: "root" }]
  }], () => [], null);
})();
...
function HealthSummaryComponent_ng_container_0_Conditional_2_For_11_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, HealthSummaryComponent_ng_container_0_Conditional_2_For_11_Conditional_8_Template, 2, 1, "td");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function HealthSummaryComponent_ng_container_0_Conditional_2_For_13_Conditional_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "td");
  }
}
function HealthSummaryComponent_ng_container_0_Conditional_2_For_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "tr")(1, "td", 2)(2, "mat-icon");
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, HealthSummaryComponent_ng_container_0_Conditional_2_For_13_Conditional_8_Template, 1, 0, "td");
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate2(" ", t_r1("health.worker"), ": ", t_r1("health.workers." + worker_r4.key), " ");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", t_r1("health.statuses." + (worker_r4.started ? "started" : "inactive")), " ");
    \u0275\u0275advance();
    \u0275\u0275conditional(ctx_r1.health.result.status === "down" ? 8 : -1);
  }
}
function HealthSummaryComponent_ng_container_0_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(8, HealthSummaryComponent_ng_container_0_Conditional_2_Conditional_8_Template, 2, 1, "th");
    \u0275\u0275elementEnd()();
    ...
    \u0275\u0275repeaterCreate(12, HealthSummaryComponent_ng_container_0_Conditional_2_For_13_Template, 9, 5, "tr", null, _forTrack0);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    const t_r1 = \u0275\u0275nextContext().$implicit;
    ...
    \u0275\u0275advance(2);
    \u0275\u0275repeater(ctx_r1.health.result.workers);
  }
}
function HealthSummaryComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementContainerStart(0);
    \u0275\u0275conditionalCreate(1, HealthSummaryComponent_ng_container_0_Conditional_1_Template, 2, 2, "p")(2, HealthSummaryComponent_ng_container_0_Conditional_2_Template, 14, 3, "table", 1);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
...
var HealthSummaryComponent = class _HealthSummaryComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HealthSummaryComponent, selectors: [["app-health-summary"]], standalone: false, decls: 1, vars: 0, consts: [[4, "transloco"], [1, "table-health"], [1, "td-icon"], ["scope", "row"]], template: function HealthSummaryComponent_Template(rf, ctx) {
      if (rf & 1) {
...
function HealthCardComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(7);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(8, "mat-card-content", 2);
    \u0275\u0275element(9, "app-health-summary");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", t_r1("health.bitmagnet_is_status", \u0275\u0275pureFunction1(2, _c02, t_r1("health.statuses." + (ctx_r1.health.result.error ? "down" : ctx_r1.health.result.status)))), " ");
  }
}
var HealthCardComponent = class _HealthCardComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HealthCardComponent, selectors: [["app-health-card"]], standalone: false, decls: 1, vars: 0, consts: [[4, "transloco"], [1, "dashboard-card", "dashboard-card-health"], [1, "dashboard-card-content"]], template: function HealthCardComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, HealthCardComponent_ng_container_0_Template, 10, 4, "ng-container", 0);
      }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HealthCardComponent, [{
    type: Component,
    args: [{ selector: "app-health-card", standalone: false, template: '<ng-container *transloco="let t">\n  <mat-card class="dashboard-card dashboard-card-health">\n    <mat-card-header>\n      <mat-card-title>\n        <h3>\n          <mat-icon>{{ health.result.icon }}</mat-icon>\n          {{\n            t("health.bitmagnet_is_status", {\n              status: t(\n                "health.statuses." +\n                  (health.result.error ? "down" : health.result.status)\n              ),\n            })\n          }}\n        </h3>\n      </mat-card-title>\n    </mat-card-header>\n    <mat-card-content class="dashboard-card-content">\n      <app-health-summary></app-health-summary>\n    </mat-card-content>\n  </mat-card>\n</ng-container>\n', styles: ["/* src/app/health/health-card.component.scss */\n.dashboard-card-health {\n  position: absolute;\n  top: 15px;\n  left: 15px;\n  right: 15px;\n  bottom: 15px;\n}\n.dashboard-card-health h3 {\n  margin-top: 0;\n}\n.dashboard-card-health h3 mat-icon {\n  position: relative;\n  top: 3px;\n  margin-left: 4px;\n  margin-right: 6px;\n}\n/*# sourceMappingURL=health-card.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
function HealthWidgetComponent_ng_container_0_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275element(3, "app-health-summary");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-dialog-actions")(5, "button", 4);
    \u0275\u0275text(6);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", t_r4("health.summary"), ": ", t_r4("health.bitmagnet_is_status", \u0275\u0275pureFunction1(3, _c03, t_r4("health.statuses." + (ctx_r2.health.result.error ? "down" : ctx_r2.health.result.status)))), " ");
    \u0275\u0275advance(5);
...
function HealthWidgetComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275template(4, HealthWidgetComponent_ng_container_0_ng_template_4_Template, 7, 5, "ng-template", null, 0, \u0275\u0275templateRefExtractor);
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("matTooltip", t_r4("health.bitmagnet_is_status", \u0275\u0275pureFunction1(4, _c03, t_r4("health.statuses." + ctx_r2.health.result.status))));
    \u0275\u0275advance(2);
...
var HealthWidgetComponent = class _HealthWidgetComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _HealthWidgetComponent, selectors: [["app-health-widget"]], standalone: false, decls: 1, vars: 0, consts: [["healthDialog", ""], [4, "transloco"], ["mat-icon-button", "", 3, "click", "matTooltip"], ["matDialogTitle", ""], ["mat-button", "", "matDialogClose", "", "color", "primary"]], template: function HealthWidgetComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, HealthWidgetComponent_ng_container_0_Template, 6, 6, "ng-container", 1);
      }
    }, dependencies: [TranslocoDirective, MatIcon, MatTooltip, MatDialogClose, MatDialogTitle, MatDialogActions, MatDialogContent, MatButton, MatIconButton, HealthSummaryComponent], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HealthWidgetComponent, [{
    type: Component,
    args: [{ selector: "app-health-widget", standalone: false, template: `<ng-container *transloco="let t">
  <button
    mat-icon-button
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(HealthModule, [{
    type: NgModule,
    args: [{
      imports: [
        GraphQLModule,
...
var ThemeEmitterColorComponent = class _ThemeEmitterColorComponent {
  ...
  static {
    ...
    }, inputs: { color: "color" }, decls: 2, vars: 2, consts: [["element", ""]], template: function ThemeEmitterColorComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ThemeEmitterColorComponent, [{
    type: Component,
    args: [{
...
var ThemeEmitterComponent = class _ThemeEmitterComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ThemeEmitterComponent, selectors: [["app-theme-emitter"]], viewQuery: function ThemeEmitterComponent_Query(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275viewQuery(_c05, 5)(ThemeEmitterColorComponent, 5);
      }
      if (rf & 2) {
        let _t;
    ...
    }, decls: 5, vars: 0, consts: [["lightdark", ""], [3, "color"], [1, "theme-emitter-lightdark"]], template: function ThemeEmitterComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementContainerStart(0);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ThemeEmitterComponent, [{
    type: Component,
    args: [{ selector: "app-theme-emitter", standalone: true, imports: [ThemeEmitterColorComponent], template: '<ng-container>\n  @for (c of themeColors; track c) {\n    <app-theme-emitter-color [color]="c" />\n  }\n  <div class="theme-emitter-lightdark" #lightdark></div>\n</ng-container>\n', styles: ["/* src/app/themes/theme-emitter.component.scss */\n:host {\n  display: none;\n}\n.theme-emitter-color.background {\n  color: var(--mat-app-background-color);\n}\n.theme-emitter-color.foreground {\n  color: var(--mat-app-text-color);\n}\n/*# sourceMappingURL=theme-emitter.component.css.map */\n"] }]
  }], () => [], { elements: [{
    type: ViewChildren,
    args: [ThemeEmitterColorComponent]
  }], lightdark: [{
    type: ViewChild,
    args: ["lightdark"]
  }] });
...
function LayoutComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(2, LayoutComponent_ng_container_0_Conditional_2_Template, 16, 6)(3, LayoutComponent_ng_container_0_Conditional_3_Template, 7, 3);
    \u0275\u0275element(4, "span", 7)(5, "app-health-widget");
    \u0275\u0275elementStart(6, "button", 8)(7, "mat-icon");
    \u0275\u0275text(8, "apparel");
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(9, "mat-menu", 9, 0);
    \u0275\u0275repeaterCreate(11, LayoutComponent_ng_container_0_For_12_Template, 4, 4, "a", 10, _forTrack02);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(31);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(32, LayoutComponent_ng_container_0_Conditional_32_Template, 3, 1, "a", 19)(33, LayoutComponent_ng_container_0_Conditional_33_Template, 4, 2, "a", 20);
    \u0275\u0275elementEnd();
...
`, styles: ["/* src/app/layout/layout.component.scss */\n.mat-toolbar.toolbar-header {\n  position: sticky;\n  top: 0;\n  z-index: 10;\n  --mat-toolbar-title-text-size: 22px;\n  --mat-toolbar-standard-height: 56px;\n  --mat-icon-color: #fff;\n  padding: 0 20px;\n}\n.mat-toolbar.toolbar-header h1 {\n  margin-top: -2px;\n  margin-right: 20px;\n}\n.mat-toolbar.toolbar-header h1 a {\n  text-decoration: none;\n}\n.mat-toolbar.toolbar-header h1 mat-icon {\n  position: relative;\n  top: 4px;\n}\n.mat-toolbar.toolbar-header h1 .name {\n  margin-left: 10px;\n  margin-right: 16px;\n}\n.mat-toolbar.toolbar-header h1 app-version {\n  font-size: 13px;\n}\n.mat-toolbar.toolbar-header .mdc-button {\n  margin-left: 6px;\n  --mdc-text-button-label-text-weight: bold;\n  --mat-text-button-horizontal-padding: 12px;\n  --mdc-text-button-container-height: 30px;\n}\n.mat-toolbar.toolbar-header {\n  --mdc-text-button-label-text-size: 15px;\n}\n.mat-toolbar.toolbar-header nav {\n  display: flex;\n  align-items: center;\n  margin-left: 20px;\n}\n.mat-toolbar.toolbar-header nav a {\n  margin-right: 10px;\n}\n.app-content {\n  z-index: 1;\n  padding-bottom: 10px;\n}\n.layout-header-menu a.active {\n  font-weight: bold;\n}\n/*# sourceMappingURL=layout.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppComponent, [{
    type: Component,
    args: [{ selector: "app-root", standalone: true, imports: [RouterOutlet, LayoutComponent], template: "<app-layout>\n  <router-outlet />\n</app-layout>\n" }]
  }], () => [{ type: MatIconRegistry }, { type: DomSanitizer }], null);
})();
(() => {
