...
function DhtDashboardComponent_ng_container_0_For_51_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "mat-button-toggle", 11);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function DhtDashboardComponent_ng_container_0_For_58_Template(rf, ctx) {
  if (rf & 1) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", t_r4("dashboard.interval." + name_r5), " ");
  }
}
function DhtDashboardComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementStart(2, "div", 2)(3, "div", 3)(4, "mat-card", 4)(5, "mat-card-content")(6, "div", 5);
    \u0275\u0275text(7);
    \u0275\u0275pipe(8, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(10);
    \u0275\u0275elementEnd();
    \u0275\u0275element(11, "app-sparkline", 7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(12, "mat-card", 4)(13, "mat-card-content")(14, "div", 5);
    \u0275\u0275text(15);
    \u0275\u0275pipe(16, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(18);
    \u0275\u0275elementEnd();
    \u0275\u0275element(19, "app-sparkline", 7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(20, "mat-card", 4)(21, "mat-card-content")(22, "div", 5);
    \u0275\u0275text(23);
    \u0275\u0275pipe(24, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(26);
    \u0275\u0275elementEnd();
    \u0275\u0275element(27, "app-sparkline", 7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(28, "mat-card", 4)(29, "mat-card-content")(30, "div", 5);
    \u0275\u0275text(31);
    \u0275\u0275pipe(32, "number");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275text(34);
    \u0275\u0275elementEnd();
    \u0275\u0275element(35, "app-sparkline", 7);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(36, "mat-card", 4)(37, "mat-card-content")(38, "div", 5);
    \u0275\u0275text(39);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(40, "div", 6);
    \u0275\u0275text(41);
    \u0275\u0275elementEnd()()();
    \u0275\u0275elementStart(42, "mat-card", 4)(43, "mat-card-content")(44, "div", 8);
    \u0275\u0275text(45);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(46, "div", 6);
    \u0275\u0275text(47);
    \u0275\u0275elementEnd()()()();
    \u0275\u0275elementStart(48, "div", 9)(49, "mat-button-toggle-group", 10);
    ...
    \u0275\u0275repeaterCreate(50, DhtDashboardComponent_ng_container_0_For_51_Template, 2, 2, "mat-button-toggle", 11, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(52, "div", 12)(53, "mat-icon", 13);
    \u0275\u0275text(54, "autorenew");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(55, "mat-form-field", 14)(56, "mat-select", 15);
    \u0275\u0275listener("valueChange", function DhtDashboardComponent_ng_container_0_Template_mat_select_valueChange_56_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.metricsController.setAutoRefreshInterval($event));
    });
    \u0275\u0275repeaterCreate(57, DhtDashboardComponent_ng_container_0_For_58_Template, 2, 2, "mat-option", 11, \u0275\u0275repeaterTrackByIdentity);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementStart(59, "button", 16);
    \u0275\u0275listener("click", function DhtDashboardComponent_ng_container_0_Template_button_click_59_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
    ...
    \u0275\u0275element(63, "app-chart", 18);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(64, "div", 19);
    \u0275\u0275element(65, "app-chart", 20)(66, "app-chart", 20);
    \u0275\u0275elementEnd()();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("parts", \u0275\u0275pureFunction2(39, _c02, t_r4("routes.dashboard"), t_r4("routes.dht")));
    \u0275\u0275advance(6);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(8, 31, ctx_r1.dhtStats.result.nodesCountIPv4 + ctx_r1.dhtStats.result.nodesCountIPv6));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(t_r4("dashboard.dht.total_nodes"));
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx_r1.sparkTotalNodes);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(16, 33, ctx_r1.dhtStats.result.nodesCountIPv4));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(t_r4("dashboard.dht.nodes_ipv4"));
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx_r1.sparkIPv4Nodes);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(24, 35, ctx_r1.dhtStats.result.nodesCountIPv6));
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(t_r4("dashboard.dht.nodes_ipv6"));
    \u0275\u0275advance();
    \u0275\u0275property("data", ctx_r1.sparkIPv6Nodes);
    \u0275\u0275advance(4);
    \u0275\u0275textInterpolate(\u0275\u0275pipeBind1(32, 37, ctx_r1.dhtStats.result.hashesCountIPv4 + ctx_r1.dhtStats.result.hashesCountIPv6));
    \u0275\u0275advance(3);
    ...
    \u0275\u0275advance(6);
    \u0275\u0275property("value", ctx_r1.metricsController.params.autoRefresh);
    \u0275\u0275advance();
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("title", t_r4("dashboard.dht.nodes_over_time"))("$data", ctx_r1.snapshots$)("adapter", ctx_r1.nodesChartAdapter);
    \u0275\u0275advance();
    \u0275\u0275property("title", t_r4("dashboard.dht.hash_discovery"))("$data", ctx_r1.snapshots$)("adapter", ctx_r1.hashesChartAdapter);
  }
}
...
var DhtDashboardComponent = class _DhtDashboardComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _DhtDashboardComponent, selectors: [["app-dht-dashboard"]], features: [\u0275\u0275ProvidersFeature([DhtStatsService])], decls: 1, vars: 0, consts: [[4, "transloco"], [3, "parts"], [1, "dht-dashboard"], [1, "dht-stats-grid"], [1, "dht-stat-card"], [1, "dht-stat-number"], [1, "dht-stat-label"], [3, "data"], [1, "dht-stat-number", "dht-stat-number-sm"], [1, "dht-controls"], [3, "change", "value"], [3, "value"], [1, "dht-controls-right"], [1, "dht-refresh-icon"], ["subscriptSizing", "dynamic", 1, "dht-refresh-select"], [3, "valueChange", "value"], ["mat-icon-button", "", "matTooltip", "Refresh", 3, "click"], [1, "dht-composition"], [3, "title", "$data", "adapter", "height"], [1, "dht-charts"], [3, "title", "$data", "adapter"]], template: function DhtDashboardComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, DhtDashboardComponent_ng_container_0_Template, 67, 42, "ng-container", 0);
      }
    }, dependencies: [AppModule, MatOption, MatIconButton, MatButtonToggleGroup, MatButtonToggle, MatCard, MatCardContent, MatFormField, MatIcon, MatSelect, MatTooltip, TranslocoDirective, DocumentTitleComponent, ChartComponent, SparklineComponent, DecimalPipe], styles: ["\n\n.dht-dashboard[_ngcontent-%COMP%] {\n  padding: 16px;\n}\n.dht-stats-grid[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 12px;\n  grid-template-columns: repeat(auto-fit, minmax(140px, 1fr));\n  margin-bottom: 20px;\n}\n.dht-stat-card[_ngcontent-%COMP%] {\n  text-align: center;\n  border-top: 2px solid var(--dht-accent, transparent);\n}\n.dht-stat-card[_ngcontent-%COMP%]   mat-card-content[_ngcontent-%COMP%] {\n  padding: 14px 12px 8px;\n}\n.dht-stat-card[_ngcontent-%COMP%]   app-sparkline[_ngcontent-%COMP%] {\n  margin-top: 8px;\n  opacity: 0.6;\n}\n.dht-stat-number[_ngcontent-%COMP%] {\n  font-size: 26px;\n  font-weight: 600;\n  font-variant-numeric: tabular-nums;\n  line-height: 1.2;\n}\n.dht-stat-number-sm[_ngcontent-%COMP%] {\n  font-size: 16px;\n}\n.dht-stat-label[_ngcontent-%COMP%] {\n  font-size: 11px;\n  opacity: 0.5;\n  text-transform: uppercase;\n  letter-spacing: 0.5px;\n  margin-top: 4px;\n}\n.status-active[_ngcontent-%COMP%] {\n  color: var(--dht-status-active, #4caf50);\n}\n.status-inactive[_ngcontent-%COMP%] {\n  opacity: 0.4;\n}\n.dht-controls[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  flex-wrap: wrap;\n  gap: 12px;\n  margin-bottom: 16px;\n}\n.dht-controls[_ngcontent-%COMP%]   mat-button-toggle-group[_ngcontent-%COMP%] {\n  --mat-standard-button-toggle-height: 32px;\n}\n.dht-controls-right[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 4px;\n}\n.dht-refresh-icon[_ngcontent-%COMP%] {\n  font-size: 16px;\n  width: 16px;\n  height: 16px;\n  opacity: 0.4;\n}\n.dht-refresh-select[_ngcontent-%COMP%] {\n  width: 120px;\n  --mat-form-field-container-height: 32px;\n}\n.dht-composition[_ngcontent-%COMP%] {\n  margin-bottom: 16px;\n  max-width: 280px;\n}\n.dht-charts[_ngcontent-%COMP%] {\n  display: grid;\n  gap: 16px;\n}\n/*# sourceMappingURL=dht-dashboard.component.css.map */"] });
  }
};
(() => {
  ...
  <div class="dht-dashboard">
    ...
    <div class="dht-controls">
      ...
      <div class="dht-controls-right">
        <mat-icon class="dht-refresh-icon">autorenew</mat-icon>
        <mat-form-field subscriptSizing="dynamic" class="dht-refresh-select">
          <mat-select
            [value]="metricsController.params.autoRefresh"
            (valueChange)="metricsController.setAutoRefreshInterval($event)"
          >
        ...
        <button
          mat-icon-button
          (click)="metricsController.refresh()"
          matTooltip="Refresh"
        >
...
//# sourceMappingURL=chunk-SQC6UPU5.js.map
