...
function TorrentsBulkActionsComponent_ng_container_0_ng_template_4_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, TorrentsBulkActionsComponent_ng_container_0_ng_template_4_Conditional_2_Template, 2, 1, "span", 7);
  }
  if (rf & 2) {
...
function TorrentsBulkActionsComponent_ng_container_0_ng_template_7_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, "sell");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, TorrentsBulkActionsComponent_ng_container_0_ng_template_7_Conditional_2_Template, 2, 1, "span", 7);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
...
function TorrentsBulkActionsComponent_ng_container_0_ng_template_8_For_5_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275ariaProperty("aria-description", "press enter to edit");
    \u0275\u0275advance();
...
function TorrentsBulkActionsComponent_ng_container_0_ng_template_8_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("placeholder", \u0275\u0275interpolate(t_r3("torrents.tags.placeholder")))("formControl", ctx_r1.newTagCtrl)("matAutocomplete", auto_r9)("matChipInputFor", chipGrid_r8)("matChipInputSeparatorKeyCodes", ctx_r1.separatorKeysCodes)("value", ctx_r1.newTagCtrl.value);
    \u0275\u0275advance(3);
    \u0275\u0275repeater(ctx_r1.suggestedTags);
    \u0275\u0275advance(3);
    \u0275\u0275property("matTooltip", \u0275\u0275interpolate(t_r3("torrents.tags.set_tip")))("disabled", !ctx_r1.selectedItems.length);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", t_r3("torrents.tags.set"), " ");
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275interpolate(t_r3("torrents.tags.put_tip")))("disabled", !ctx_r1.selectedItems.length || !ctx_r1.editedTags.length && !ctx_r1.newTagCtrl.value);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", t_r3("torrents.tags.put"), " ");
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275interpolate(t_r3("torrents.tags.delete_tip")))("disabled", !ctx_r1.selectedItems.length || !ctx_r1.editedTags.length && !ctx_r1.newTagCtrl.value);
    \u0275\u0275advance();
...
function TorrentsBulkActionsComponent_ng_container_0_ng_template_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(1, "category");
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, TorrentsBulkActionsComponent_ng_container_0_ng_template_10_Conditional_2_Template, 2, 1, "span", 7);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
...
function TorrentsBulkActionsComponent_ng_container_0_ng_template_13_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(2, TorrentsBulkActionsComponent_ng_container_0_ng_template_13_Conditional_2_Template, 2, 1, "span", 7);
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance(2);
...
function TorrentsBulkActionsComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(7, TorrentsBulkActionsComponent_ng_container_0_ng_template_7_Template, 3, 1, "ng-template", 5)(8, TorrentsBulkActionsComponent_ng_container_0_ng_template_8_Template, 18, 19, "ng-template", 6);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(15, TorrentsBulkActionsComponent_ng_container_0_Conditional_15_Template, 2, 0, "mat-tab");
    \u0275\u0275elementEnd();
    \u0275\u0275elementContainerEnd();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275ariaProperty("aria-labelledby", "hidden");
    \u0275\u0275advance(13);
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TorrentsBulkActionsComponent, [{
    type: Component,
    args: [{ selector: "app-torrents-bulk-actions", standalone: true, imports: [AppModule, TorrentReprocessComponent], template: `<ng-container *transloco="let t">
  <mat-tab-group
    animationDuration="0"
...
`, styles: ["/* src/app/torrents/torrents-bulk-actions.component.scss */\nmat-tab-group {\n  padding-left: 10px;\n}\n.mat-mdc-card {\n  margin-bottom: 10px;\n}\nbutton {\n  margin-right: 10px;\n}\np {\n  margin-top: 0;\n}\n::ng-deep .mdc-tab[aria-labelledby=hidden] {\n  display: none;\n}\n/*# sourceMappingURL=torrents-bulk-actions.component.css.map */\n"] }]
  }], null, { selectedItems$: [{
    type: Input
  }], updated: [{
    type: Output
...
function TorrentsTableComponent_ng_container_0_td_10_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(4);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(5, TorrentsTableComponent_ng_container_0_td_10_Conditional_5_Template, 2, 1, "p", 26);
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", t_r3("content_types.singular." + (ctx_r1.item(i_r7).contentType ?? "null")));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate(((tmp_5_0 = ctx_r1.contentTypeInfo(ctx_r1.item(i_r7).contentType)) == null ? null : tmp_5_0.icon) ?? "question_mark");
    \u0275\u0275advance(2);
...
function TorrentsTableComponent_ng_container_0_td_16_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("matTooltip", \u0275\u0275interpolate(ctx_r1.item(i_r9).publishedAt));
    \u0275\u0275advance();
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind1(3, 3, ctx_r1.item(i_r9).publishedAt), " ");
  }
}
...
function TorrentsTableComponent_ng_container_0_td_19_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", ctx_r1.item(i_r10).seeders ?? "?", " / ", ctx_r1.item(i_r10).leechers ?? "?", " ");
  }
}
...
function TorrentsTableComponent_ng_container_0_td_22_Template(rf, ctx) {
  ...
  if (rf & 2) {
    ...
    const ctx_r1 = \u0275\u0275nextContext(2);
    \u0275\u0275advance();
    \u0275\u0275property("href", \u0275\u0275interpolate(ctx_r1.item(i_r11).torrent.magnetUri), \u0275\u0275sanitizeUrl);
  }
}
...
function TorrentsTableComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275template(15, TorrentsTableComponent_ng_container_0_th_15_Template, 2, 1, "th", 5)(16, TorrentsTableComponent_ng_container_0_td_16_Template, 4, 5, "td", 11);
    \u0275\u0275elementContainerEnd();
    ...
    \u0275\u0275template(21, TorrentsTableComponent_ng_container_0_th_21_Template, 2, 1, "th", 14)(22, TorrentsTableComponent_ng_container_0_td_22_Template, 3, 2, "td", 6);
    \u0275\u0275elementContainerEnd();
...
var TorrentsTableComponent = class _TorrentsTableComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TorrentsTableComponent, selectors: [["app-torrents-table"]], inputs: { dataSource: "dataSource", controller: "controller", multiSelection: "multiSelection", displayedColumns: "displayedColumns" }, outputs: { updated: "updated" }, decls: 1, vars: 0, consts: [[4, "transloco"], [1, "progress-bar-container"], [3, "mode", "value"], ["mat-table", "", 1, "table-torrents", 3, "dataSource", "multiTemplateDataRows"], ["matColumnDef", "select"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "summary"], ["mat-cell", "", 3, "click", 4, "matCellDef"], ["matColumnDef", "size"], ["matColumnDef", "publishedAt"], ["class", "td-published-at", "mat-cell", "", 4, "matCellDef"], ["matColumnDef", "peers"], ["matColumnDef", "magnet"], ["mat-header-cell", "", "style", "text-align: center", 4, "matHeaderCellDef"], ["matColumnDef", "expandedDetail"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 3, "class", 4, "matRowDef", "matRowDefColumns"], ["mat-row", "", "class", "expanded-detail-row", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], [3, "change", "checked", "indeterminate", "matTooltip"], ["mat-cell", ""], [3, "click", "change", "checked"], ["mat-cell", "", 3, "click"], [3, "matTooltip"], [1, "title"], [1, "original-name"], [3, "torrentContent"], [1, "filesize", 3, "matTooltip"], ["mat-cell", "", 1, "td-published-at"], ["matTooltipClass", "tooltip-published-at", 3, "matTooltip"], ["mat-header-cell", "", 2, "text-align", "center"], [3, "href"], ["svgIcon", "magnet"], [1, "item-detail"], [1, "torrent-permalink"], [3, "updated", "tabSelected", "torrentContent", "size", "published", "peers", "selectedTab"], ["mat-header-row", ""], ["mat-row", ""], ["mat-row", "", 1, "expanded-detail-row"]], template: function TorrentsTableComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TorrentsTableComponent, [{
    type: Component,
    args: [{ selector: "app-torrents-table", standalone: true, imports: [
      AppModule,
      FilesizePipe,
      TimeAgoPipe,
      TorrentChipsComponent,
...
`, styles: ["/* src/app/torrents/torrents-table.component.scss */\n.progress-bar-container {\n  height: 10px;\n}\nth.cdk-column-select,\ntd.cdk-column-select {\n  padding-right: 0;\n}\ntd.mat-column-summary {\n  vertical-align: middle;\n  cursor: pointer;\n  white-space: pre-wrap;\n  padding-top: 8px;\n  padding-bottom: 8px;\n}\ntd.mat-column-summary .title {\n  line-height: 30px;\n  overflow: hidden;\n  margin-right: 20px;\n  font-weight: bold;\n}\ntd.mat-column-summary .original-name {\n  margin: 2px 0 8px 34px;\n}\ntd.mat-column-summary .title,\ntd.mat-column-summary .original-name {\n  white-space: pre-wrap;\n  word-break: break-word;\n  overflow-wrap: break-word;\n}\ntd.mat-column-summary > .mat-icon {\n  display: inline-block;\n  position: relative;\n  top: 6px;\n  margin-right: 10px;\n}\ntd.mat-column-summary mat-chip-set {\n  display: inline-block;\n  margin-left: 10px;\n}\ntd.mat-column-summary mat-chip-set mat-chip {\n  margin: 2px 10px 2px 0;\n}\ntr.expanded-detail-row {\n  height: 0;\n}\ntr.mat-mdc-row.expanded td {\n  border-bottom: 0;\n}\napp-torrent-content {\n  padding-top: 20px;\n  padding-bottom: 20px;\n}\n.mat-column-magnet {\n  text-align: center;\n}\n.mat-column-magnet .mat-icon {\n  position: relative;\n  top: 3px;\n}\n.item-detail {\n  width: 100%;\n  overflow: hidden;\n}\n.td-published-at abbr {\n  cursor: default;\n  text-decoration: underline;\n  text-decoration-style: dotted;\n}\n.cdk-column-peers {\n  white-space: nowrap;\n}\nspan.filesize {\n  text-decoration: underline;\n  text-decoration-style: dotted;\n  cursor: default;\n}\n/*# sourceMappingURL=torrents-table.component.css.map */\n"] }]
  }], null, { dataSource: [{
    type: Input
  }], controller: [{
    type: Input
...
//# sourceMappingURL=chunk-O5PZHSQQ.js.map
