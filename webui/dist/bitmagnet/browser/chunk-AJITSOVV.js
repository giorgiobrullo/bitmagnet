...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(QueueEnqueueReprocessTorrentsBatchDialogComponent, [{
    type: Component,
    args: [{ selector: "app-queue-enqueue-reprocess-torrents-batch-dialog", standalone: true, imports: [AppModule], template: `<ng-container *transloco="let t">
  <mat-card>
    <h2 mat-dialog-title>
...
`, styles: ["/* src/app/dashboard/queue/queue-enqueue-reprocess-torrents-batch-dialog.component.scss */\nmat-grid-tile mat-card {\n  width: 100%;\n  height: 100%;\n}\n.select-content-types {\n  margin-top: 10px;\n}\n/*# sourceMappingURL=queue-enqueue-reprocess-torrents-batch-dialog.component.css.map */\n"] }]
  }], null, { data: [{
    type: Inject,
...
function QueuePurgeJobsDialogComponent_ng_container_0_Conditional_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, QueuePurgeJobsDialogComponent_ng_container_0_Conditional_7_Conditional_0_Template, 2, 2, "p")(1, QueuePurgeJobsDialogComponent_ng_container_0_Conditional_7_Conditional_1_Template, 2, 1, "p");
  }
  if (rf & 2) {
    const ctx_r2 = \u0275\u0275nextContext(2);
...
function QueuePurgeJobsDialogComponent_ng_container_0_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "mat-dialog-content");
    \u0275\u0275conditionalCreate(5, QueuePurgeJobsDialogComponent_ng_container_0_Conditional_5_Template, 14, 6)(6, QueuePurgeJobsDialogComponent_ng_container_0_Conditional_6_Template, 1, 0, "mat-spinner")(7, QueuePurgeJobsDialogComponent_ng_container_0_Conditional_7_Template, 2, 1);
    \u0275\u0275elementEnd();
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(QueuePurgeJobsDialogComponent, [{
    type: Component,
    args: [{ selector: "app-queue-purge-jobs-dialog", standalone: true, imports: [AppModule, GraphQLModule], template: `<ng-container *transloco="let t">
  <mat-card>
    <h2 mat-dialog-title>{{ t("dashboard.queues.purge_queue_jobs") }}</h2>
    <mat-dialog-content>
      @if (stage === "PENDING") {
        <section>
        ...
        <section>
          ...
          @for (status of statusNames; track status) {
            <mat-checkbox
              ...
              (change)="handleStatusEvent($event)"
              >{{ t("dashboard.queues." + status) }}</mat-checkbox
            >
          }
        </section>
      } @else if (stage === "REQUESTING") {
...
`, styles: ["/* src/app/dashboard/queue/queue-purge-jobs-dialog.component.scss */\nmat-dialog-content {\n  min-height: 240px;\n  overflow: visible;\n}\nmat-grid-tile mat-card {\n  width: 100%;\n  height: 100%;\n}\n/*# sourceMappingURL=queue-purge-jobs-dialog.component.css.map */\n"] }]
  }], null, { data: [{
    type: Inject,
    args: [MAT_DIALOG_DATA]
  }] });
...
var QueueAdminComponent = class _QueueAdminComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _QueueAdminComponent, selectors: [["app-queue-admin"]], decls: 1, vars: 0, consts: [[4, "transloco"], [3, "parts"], ["mat-button", "", 3, "click"]], template: function QueueAdminComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275template(0, QueueAdminComponent_ng_container_0_Template, 11, 7, "ng-container", 0);
      }
    }, dependencies: [AppModule, MatButton, MatCard, MatCardContent, TranslocoDirective, DocumentTitleComponent], styles: ["\n\nul[_ngcontent-%COMP%] {\n  list-style-type: none;\n  padding-left: 0;\n}\nul[_ngcontent-%COMP%]   li[_ngcontent-%COMP%] {\n  margin-bottom: 6px;\n}\n/*# sourceMappingURL=queue-admin.component.css.map */"] });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(QueueAdminComponent, [{
    type: Component,
    args: [{ selector: "app-queue-admin", standalone: true, imports: [AppModule, DocumentTitleComponent], template: `<ng-container *transloco="let t">
  <app-document-title
    [parts]="[t('routes.admin'), t('routes.queues'), t('routes.dashboard')]"
  />
  <mat-card>
    <mat-card-content>
      <ul>
        ...
        <li>
          <a mat-button (click)="openDialogEnqueueReprocessTorrentsBatch()">{{
            t("dashboard.queues.enqueue_torrent_processing_batch")
          }}</a>
        </li>
      </ul>
...
`, styles: ["/* src/app/dashboard/queue/queue-admin.component.scss */\nul {\n  list-style-type: none;\n  padding-left: 0;\n}\nul li {\n  margin-bottom: 6px;\n}\n/*# sourceMappingURL=queue-admin.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
...
//# sourceMappingURL=chunk-AJITSOVV.js.map
