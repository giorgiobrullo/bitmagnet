...
var ChartComponent = class _ChartComponent {
  constructor() {
    ...
    this.hiddenDatasets = /* @__PURE__ */ new Map();
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ChartComponent, selectors: [["app-chart"]], inputs: { title: "title", $data: "$data", adapter: "adapter", width: "width", height: "height" }, decls: 1, vars: 0, consts: [[4, "transloco"], [3, "click", "matTooltip"], ["baseChart", "", 3, "data", "options", "type", "height", "width"]], template: function ChartComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ChartComponent, [{
    type: Component,
    args: [{ selector: "app-chart", standalone: true, imports: [
      BaseChartDirective,
      MatCard,
      MatCardContent,
      MatCardHeader,
  ...
  <mat-card>
    <mat-card-header>
      <mat-card-title>
        <h4>
          <mat-icon
            [matTooltip]="t('dashboard.metrics.toggle_legend')"
            [class]="
              'icon-toggle-legend ' +
              (legend ? 'icon-toggle-legend-active' : '')
            "
            (click)="toggleLegend()"
...
`, styles: ["/* src/app/charting/chart.component.scss */\n.icon-toggle-legend {\n  cursor: pointer;\n  position: relative;\n  top: 4px;\n  margin-right: 8px;\n  opacity: 0.6;\n}\n.icon-toggle-legend.icon-toggle-legend-active {\n  opacity: 1;\n}\n.app-chart {\n  position: relative;\n}\n.app-chart-small {\n  position: relative;\n  max-width: 100%;\n}\n/*# sourceMappingURL=chart.component.css.map */\n"] }]
  }], null, { title: [{
    type: Input
  }], $data: [{
    type: Input
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ChartComponent, { className: "ChartComponent", filePath: "src/app/charting/chart.component.ts", lineNumber: 40 });
})();
...
//# sourceMappingURL=chunk-LL3XDJGZ.js.map
