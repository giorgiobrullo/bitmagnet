...
function QueueJobsTableComponent_ng_container_0_td_19_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, QueueJobsTableComponent_ng_container_0_td_19_Conditional_1_Template, 2, 5);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function QueueJobsTableComponent_ng_container_0_td_25_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275conditionalCreate(1, QueueJobsTableComponent_ng_container_0_td_25_Conditional_1_Template, 2, 3);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    let tmp_4_0;
...
function QueueJobsTableComponent_ng_container_0_td_27_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(12);
    \u0275\u0275elementEnd();
    \u0275\u0275conditionalCreate(13, QueueJobsTableComponent_ng_container_0_td_27_Conditional_13_Template, 5, 4);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    let tmp_13_0;
...
var QueueJobsTableComponent = class _QueueJobsTableComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _QueueJobsTableComponent, selectors: [["app-queue-jobs-table"]], inputs: { dataSource: "dataSource", selection: "selection", displayedColumns: "displayedColumns" }, outputs: { updated: "updated" }, decls: 1, vars: 0, consts: [[4, "transloco"], [1, "progress-bar-container"], [3, "mode", "value"], ["mat-table", "", 1, "table-results", 3, "dataSource", "multiTemplateDataRows"], ["matColumnDef", "id"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 3, "click", 4, "matCellDef"], ["matColumnDef", "queue"], ["matColumnDef", "priority"], ["matColumnDef", "status"], ["matColumnDef", "error"], ["matColumnDef", "createdAt"], ["mat-header-cell", "", "style", "text-align: center", 4, "matHeaderCellDef"], ["matColumnDef", "ranAt"], ["matColumnDef", "expandedDetail"], ["mat-cell", "", 4, "matCellDef"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 3, "class", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", "", 3, "click"], ["mat-header-cell", "", 2, "text-align", "center"], ["mat-cell", ""], [1, "item-detail"], [1, "copy", 3, "matTooltip", "cdkCopyToClipboard"], [1, "payload"], ["mat-header-row", ""], ["mat-row", ""]], template: function QueueJobsTableComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(QueueJobsTableComponent, [{
    type: Component,
    args: [{ selector: "app-queue-jobs-table", standalone: true, imports: [AppModule, TimeAgoPipe], animations: [
      trigger("detailExpand", [
        state("collapsed,void", style({ height: "0px", minHeight: "0" })),
        state("expanded", style({ height: "*" })),
        transition("expanded <=> collapsed", animate("225ms cubic-bezier(0.4, 0.0, 0.2, 1)"))
...
`, styles: ["/* src/app/dashboard/queue/queue-jobs-table.component.scss */\n.item-detail > :first-child {\n  padding-top: 20px;\n}\n.item-detail > :last-child {\n  margin-bottom: 20px;\n}\ntr:not(.expanded-detail-row) td {\n  cursor: pointer;\n}\ntr.expanded-detail-row {\n  height: 0;\n}\ntr.expanded-detail-row h5 {\n  margin: 0;\n  padding-top: 8px;\n}\ntr.expanded-detail-row p {\n  margin: 0;\n  padding-top: 8px;\n  padding-bottom: 4px;\n}\ntr.expanded-detail-row span.copy {\n  cursor: crosshair;\n  text-decoration: underline;\n  text-decoration-style: dotted;\n}\npre {\n  opacity: 0;\n  max-height: 200px;\n  max-width: 100px;\n  overflow: scroll;\n  background: rgba(119, 119, 119, 0.2);\n  padding: 10px;\n}\n.expanded-detail-row.expanded pre {\n  opacity: 1;\n  max-width: 1200px;\n}\n/*# sourceMappingURL=queue-jobs-table.component.css.map */\n"] }]
  }], null, { dataSource: [{
    type: Input
  }], selection: [{
    type: Input
...
function QueueJobsComponent_ng_container_0_For_6_Template(rf, ctx) {
  if (rf & 1) {
    ...
    \u0275\u0275text(3);
    \u0275\u0275elementEnd()();
    \u0275\u0275conditionalCreate(4, QueueJobsComponent_ng_container_0_For_6_Conditional_4_Template, 3, 0, "mat-card-content", 18)(5, QueueJobsComponent_ng_container_0_For_6_Conditional_5_Template, 3, 0, "mat-card-content", 19);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(QueueJobsComponent, [{
    type: Component,
    args: [{ selector: "app-queue-jobs", standalone: true, imports: [
      AppModule,
      PaginatorComponent,
      QueueJobsTableComponent,
      DocumentTitleComponent
...
`, styles: ["/* src/app/dashboard/queue/queue-jobs.component.scss */\n.drawer {\n  width: 220px;\n}\n.query-form {\n  padding-top: 20px;\n  padding-bottom: 10px;\n  position: relative;\n  clear: both;\n  display: flex;\n  flex-wrap: wrap;\n}\n.query-form .form-field-container {\n  display: inline-flex;\n  flex-direction: column;\n  position: relative;\n  margin-left: 20px;\n  padding-bottom: 20px;\n}\n.query-form .form-field-container button {\n  top: 8px;\n}\n.query-form .form-field-container.form-field-container-order-by {\n  padding-right: 40px;\n}\n.query-form .form-field-container.form-field-container-order-by button {\n  position: absolute;\n  right: 0;\n}\n.query-form .form-field-container.button-container-toggle-drawer {\n  margin-left: 5px;\n}\n.query-form .button-container-toggle-direction {\n  margin-left: 4px;\n}\napp-paginator {\n  float: right;\n  padding-top: 14px;\n  padding-bottom: 20px;\n}\n/*# sourceMappingURL=queue-jobs.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
...
//# sourceMappingURL=chunk-D3UZNDYF.js.map
