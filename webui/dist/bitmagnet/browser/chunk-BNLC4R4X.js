...
// src/app/errors/errors.service.ts
var ErrorsService = class _ErrorsService {
  constructor(snackBar) {
    this.snackBar = snackBar;
    this.expiry = 1e3 * 10;
  }
  addError(message, expiry = this.expiry) {
  ...
  static {
    this.\u0275fac = function ErrorsService_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _ErrorsService)(\u0275\u0275inject(MatSnackBar));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ErrorsService, factory: _ErrorsService.\u0275fac, providedIn: "root" });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(ErrorsService, [{
    type: Injectable,
...
//# sourceMappingURL=chunk-BNLC4R4X.js.map
