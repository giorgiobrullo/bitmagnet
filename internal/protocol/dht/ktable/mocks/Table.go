...
func (_m *Table) Stats() ktable.TableStats {
	ret := _m.Called()
	...
	var r0 ktable.TableStats
	if rf, ok := ret.Get(0).(func() ktable.TableStats); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(ktable.TableStats)
	}
...
func (_c *Table_Stats_Call) Return(_a0 ktable.TableStats) *Table_Stats_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Table_Stats_Call) RunAndReturn(run func() ktable.TableStats) *Table_Stats_Call {
	_c.Call.Return(run)
	return _c
}
