...
/*
	func (r *torrentQueryResolver) LibraryMetrics(ctx context.Context, obj *gqlmodel.TorrentQuery, input gen.TorrentLibraryMetricsInput) (gen.TorrentLibraryMetricsResult, error) {
	panic(fmt.Errorf("not implemented: LibraryMetrics - libraryMetrics"))
}
func (r *torrentQueryResolver) ContentBreakdown(ctx context.Context, obj *gqlmodel.TorrentQuery) ([]gen.TorrentContentBreakdown, error) {
	panic(fmt.Errorf("not implemented: ContentBreakdown - contentBreakdown"))
}
*/
