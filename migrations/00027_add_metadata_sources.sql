...
VALUES ('porndb', 'PornDB', now(), now()),
       ...
       ('discogs', 'Discogs', now(), now()),
       ('deezer', 'Deezer', now(), now())
...
WHERE key IN ('porndb', 'stashdb', 'musicbrainz', 'openlibrary', 'comicvine', 'igdb', 'anilist', 'myanimelist', 'googlebooks', 'discogs', 'deezer');
-- +goose StatementEnd
